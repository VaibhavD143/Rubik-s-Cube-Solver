two bad edges 3,5
def __init__(self):
		self.front = ['g','w','r','r','b','g','o','g','b']
		self.back = ['b','g','b','o','g','r','g','y','r']
		self.left = ['o','r','r','w','y','b','g','b','y']
		self.right = ['y','w','r','w','w','g','o','y','w']
		self.up = ['w','r','w','y','r','o','y','b','b']
		self.down = ['g','y','y','o','o','o','w','b','o']
